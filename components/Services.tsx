...
const Services: React.FC<ServicesProps> = ({ 
  title = "What We Offer 🌟", 
  subtitle = "We integrate seamlessly as an optional, on-demand childcare add-on — providing discreet, professional care so your guests can fully enjoy every ceremony.",
  items = DEFAULT_ITEMS
}) => {
  return (
